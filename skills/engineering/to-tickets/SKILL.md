...
The issue tracker and triage label vocabulary should have been provided to you — run `/setup-matt-pocock-skills` if not. Artifact paths are in the Workflow paths table in `CLAUDE.md`/`AGENTS.md`.
